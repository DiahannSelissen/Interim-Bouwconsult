...
const Bouwkundigadvies = () => {
  return (
    <div>
      <NavBarSubpages />
      <h1 id="Bouwkundig advies" className="subpageTitle">
        Bouwkundig advies
      </h1>
      <div className="subpageRedBar">
        <div className="redBar"></div>
      </div>
      <p>Bouwkundig advies kan gedurende het ontwerp gegeven worden met betrekking tot materiaal gebruik, principe-detaillering en bouwfysische aspecten zoals warmte, vocht en geluid. Tijdens de bouwvoorbereidingsperiode kan een beoordeling van bestek- en bestekstekeningen waardevol blijken voor de nadere uitwerking van een project.
...
export default Bouwkundigadvies;
